...
macro_rules! mls_error {
    ($($arg:tt)*) => {
        $crate::api::logger::_log($crate::api::logger::Level::Error, &format!($($arg)*));
    };
}
...
macro_rules! mls_warn {
    ($($arg:tt)*) => {
        $crate::api::logger::_log($crate::api::logger::Level::Warn, &format!($($arg)*));
    };
}
...
macro_rules! mls_info {
    ($($arg:tt)*) => {
        $crate::api::logger::_log($crate::api::logger::Level::Info, &format!($($arg)*));
    };
}
...
macro_rules! mls_debug {
    ($($arg:tt)*) => {
        $crate::api::logger::_log($crate::api::logger::Level::Debug, &format!($($arg)*));
    };
}
